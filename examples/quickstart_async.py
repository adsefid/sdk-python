"""Send a single SMS with the async AdsefidAsyncClient.

Usage:
    ADSEFID_API_KEY=... python examples/quickstart_async.py
"""
...
async def main() -> None:
    ...
    async with AdsefidAsyncClient(api_key=api_key) as client:
        try:
